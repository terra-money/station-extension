...
export const validate = {
    ...
    password: {
        ...
        length: (password: string) => password.length >= 10 || 'Password must be longer than 10 characters',
    },

    confirm: (password: string, confirm: string) => password === confirm || 'Password does not match',
