  ...
  <Form onSubmit={handleSubmit(submit)}>
    ...
    >
      <Input  // import from Input.tsx
        ...
        token={asset} //from another imput not displayed here.
        inputMode='decimal'
        placeholder={'0.00'}
      />
    </FormItem>
...
* This example is the primary way `<Form />`'s are used in the app.
* Some components have Submit buttons built in for example: `<Tx>` So, you don't need to use `<Submit />` for those.
...
* This example is the primary way`<FormGroup />`'s are used in the app.
<div className='story_with_source_below'>
  <Canvas>
...
## FormItem
This is the wrapper around an input item with a label and error message.
<div className='story_with_source_below'>
  <Canvas>
